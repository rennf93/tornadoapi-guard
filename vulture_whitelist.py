# noqa
"""
Vulture whitelist for TornadoAPI Guard.
...
# Tornado specific - these are used by Tornado's handler system
# and may appear unused to static analysis
app  # type: ignore  # pragma: no cover
prepare  # type: ignore  # pragma: no cover
on_finish  # type: ignore  # pragma: no cover
...
write  # type: ignore  # pragma: no cover
finish  # type: ignore  # pragma: no cover
set_status  # type: ignore  # pragma: no cover
set_header  # type: ignore  # pragma: no cover
add_header  # type: ignore  # pragma: no cover
initialize  # type: ignore  # pragma: no cover
