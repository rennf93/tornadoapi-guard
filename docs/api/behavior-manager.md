...
title: Behavior Manager API - TornadoAPI Guard
description: API reference for managing behavioral analysis and monitoring through decorators
keywords: behavior manager, tornadoapi guard, behavioral analysis, monitoring, automated actions
---

Behavior Manager
=================

The Behavior Manager handles behavioral analysis and monitoring for TornadoAPI Guard, providing advanced detection capabilities for suspicious usage patterns and automated response actions.
