...
title: Redis Integration - TornadoAPI Guard
description: Guide to using Redis for distributed state management in TornadoAPI Guard
...
TornadoAPI Guard uses Redis for distributed state management across multiple instances.
...
Example: `tornadoapi_guard:cloud_ranges:AWS`
