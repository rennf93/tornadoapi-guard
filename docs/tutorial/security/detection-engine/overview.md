...
The Detection Engine is an evolution of TornadoAPI Guard's suspicious patterns system, introducing:
...
```mermaid
flowchart TB
    Request[Tornado Request] --> DPA[detect_penetration_attempt]
