...
title: Rate Limiting - TornadoAPI Guard
description: Learn how to implement rate limiting in your Tornado application using TornadoAPI Guard
keywords: rate limiting, api security, ddos protection, request throttling, tornado
---

Rate Limiting
=============

Rate limiting is a crucial security feature that protects your API from abuse, DoS attacks, and excessive usage. TornadoAPI Guard provides a robust rate limiting system through the dedicated `RateLimitManager` class.
...
TornadoAPI Guard implements a sliding window rate limiting algorithm:
...
TornadoAPI Guard supports two rate limiting storage backends:
