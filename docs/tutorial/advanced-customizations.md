...
title: Advanced Customization - TornadoAPI Guard
description: Learn how to extend TornadoAPI Guard with custom protocols and handlers
keywords: custom protocols, extending tornadoapi guard, advanced customization
---

Advanced Customization
=======================

TornadoAPI Guard uses a protocol-based architecture that makes it highly extensible. This guide explains how the protocol system works and how to create custom implementations.
...
TornadoAPI Guard uses Python's Protocol system to define interfaces that components must implement. This allows you to:
...
The TornadoAPI Guard initialization flow works like this:
...
class CustomGeoIPHandler:
    ...
    def __init__(self, license_key: str, db_path: str = "CustomGeoIP.mmdb"):
        ...
        self.reader = None
        self.redis = None  # Will store the TornadoAPI Guard's Redis handler
    ...
    async def initialize_redis(self, redis_handler: RedisHandlerProtocol) -> None:
        ...
        self.redis = redis_handler  # Store the Redis handler provided by TornadoAPI Guard
...
1. TornadoAPI Guard's middleware will call your handler's `initialize_redis()` method
...
Remember: You don't implement the RedisHandlerProtocol yourself - TornadoAPI Guard provides its built-in RedisManager which meets this protocol and is automatically passed to your custom GeoIPHandler.
