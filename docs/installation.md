...
title: Installation - TornadoAPI Guard
description: Learn how to install and set up TornadoAPI Guard, a comprehensive security middleware for Tornado applications
keywords: tornadoapi guard installation, python security middleware, tornado security setup
---
...
Before using `tornadoapi-guard`'s country filtering features, obtain an IPInfo token:
